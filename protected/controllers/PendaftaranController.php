...
class PendaftaranController extends Controller
{
	...
	public function accessRules()
	{
		return array(
			...
			array('allow', // allow authenticated user to perform 'create' and 'update' actions
				'actions'=>array('create','update','viewDaftar'),
				'users'=>array('@'),
			),
	...
	public function actionViewDaftar()
	{
		$us = Yii::app()->user->id;
        $id = Pendaftaran::model()->findAllByAttributes(array('idpengguna'=>$us));

		$this->render('viewDaftar',array(
			'model'=>$this->loadModel(array('idpengguna'=>$id)),
		));
	}
	/**
	 * Creates a new model.
	...
	public function actionCreate($id)
	{
		...
		if(isset($_POST['Pendaftaran']))
		{
			...
			if($model->save())
				$this->redirect(array('view','id'=>$model->idpendseminar));
		}
