                                    ...
                                    <div class="navbar-collapse collapse ">
                                        <ul class="nav navbar-nav navbar-right">
                                            ...
                                            <?php if (!Yii::app()->user->isGuest && Yii::app()->user->level == 1) : ?>
                                                ...
                                                <li class="menu-top"><a href="<?php echo Yii::app()->createUrl('pendaftaran/admin&id=2'); ?>">Pendaftar Kolokium</a></li>
                                            <?php endif; ?>
                                            ...
                                            <?php if (!Yii::app()->user->isGuest && Yii::app()->user->level == 3 && $count==0) : ?>
                                                ...
                                                <li class="menu-top"><a href="<?php echo Yii::app()->createUrl('pendaftaran/create&id=2'); ?>">Daftar Kolokium</a></li>
                                            <?php endif; ?>
